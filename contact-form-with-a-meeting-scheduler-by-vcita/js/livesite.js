jQuery( function($) {
	...
	var vcita_connect = function ( e ) {
		...
		var new_location = get_vcita_connect_url();

		window.location = new_location;

	};

	// Go to reconnect url for use with legacy sidebar widget
	var vcita_reconnect = function ( e ) {

		e.preventDefault();

		var new_location = get_vcita_connect_url( true );

		window.location = new_location;

	};

  $('.js-vcita-connect').click( vcita_connect );
  $('.js-vcita-reconnect').click( vcita_reconnect );
