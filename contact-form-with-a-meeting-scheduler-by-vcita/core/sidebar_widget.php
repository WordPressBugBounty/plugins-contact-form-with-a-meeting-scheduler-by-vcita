...
class ls_sidebar_widget {
	...
	function enqueue_scripts( $hook_suffix ) {
		...
		$nonce = wp_create_nonce( 'vcita_callback' );
	...
	function vcita_widget_admin() { ?>
        ...
        <div id="vcita_config">
			...
			<?php }
                ...
                <input class="vcita-email" type="text" disabled="disabled"
                       value="<?php echo $vcita_params[ 'email' ]; ?>"/>
                <br><br>
                <a href="#" class="js-vcita-reconnect button button-primary">Change Email</a>
                <br><br>
                <a data-open-popup class="button button-primary"
                   href="https://www.vcita.com/widget_implementations?platform=wordpress&widget=sidebar&key=<?php $vcita_params[ 'uid' ] ?>">Edit</a>
			<?php } ?>
        </div>
	<?php }
